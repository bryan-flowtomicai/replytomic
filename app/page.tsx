        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-fr">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="md:col-span-2 p-8 rounded-xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 hover:border-white/20 transition-all group"
            >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="p-8 rounded-xl border border-white/10 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 hover:border-white/20 transition-all group"
            >
              <div className="flex items-center gap-4 mb-4">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="p-8 rounded-xl border-2 border-blue-500 bg-gradient-to-br from-purple-500/20 to-blue-500/20 relative"
            >
